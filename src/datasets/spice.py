...
import os
import torch as pt
from src.datasets.memdataset import MemmappedDataset
...
class SPICE(MemmappedDataset):
    ...
    def __init__(
        ...
        version = dataset_arg.get('version')
        subsets = dataset_arg.get('subsets', [])
        max_gradient = dataset_arg.get('max_gradient', None)
