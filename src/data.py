...
from src.utils import MissingLabelException, make_splits
...
class DataModule(LightningDataModule):
    ...
    def _prepare_SPICE_dataset(self):

        self.dataset = SPICE(root=self.hparams["dataset_root"], dataset_arg=self.hparams["dataset_arg"])
        train_size = self.hparams["train_size"]
        val_size = self.hparams["val_size"]
